    ...
    <div class="content">
      <div class="imageWrapper">
        <div class="LazyLoad is-visible">
          <van-image :src="youlike.small_image">
      ...
      <div class="infoWrapper">
        <div class="name">
          <span class="nameText">{{youlike.name}}</span>
        </div>
        ...
        <div class="priceWrapper">
          <div class="priceInfo">
            <div class="pricePart">
              <div class="price">{{youlike.price | moneyFormat}}</div>
              <div class="originPrice">{{youlike.origin_price | moneyFormat}}</div>
            </div>
          </div>
