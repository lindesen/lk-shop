...
//用户名密码登录(POST)
export const pwdLogin = (user_name, pwd, captcha) => ajax(LOCAL_BASE_URL + '/api/login_pwd', { user_name, pwd, captcha }, 'POST');

//用户自动登录
//http://demo.itlike.com/web/xlmc/api/userinfo
export const getPass = () => ajax(LOCAL_BASE_URL + '/api/userinfo');
...
/**
 1）添加商品
请求方式：POST 参数：{user_id: String, goods_id: String, goods_name: String, goods_price: Number, small_image:
String}
